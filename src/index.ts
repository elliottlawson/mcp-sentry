...
const MISSING_AUTH_TOKEN_MESSAGE = 
  'Sentry authentication token not found. Please specify your Sentry auth token using --auth-token or the SENTRY_TOKEN environment variable.';
